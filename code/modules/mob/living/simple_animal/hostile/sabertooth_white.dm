/mob/living/simple_animal/hostile/sabertooth_white
	name = "Sabertooth"
...
/mob/living/simple_animal/hostile/sabertooth_white/Life()
	. =..()
	if (!.)
		return
...
/mob/living/simple_animal/hostile/sabertooth_white/attackby(var/obj/item/O as obj, var/mob/user as mob)
...
/mob/living/simple_animal/hostile/sabertooth_white/attack_hand(mob/living/carbon/human/M as mob)
	if (stance != HOSTILE_STANCE_ATTACK && stance != HOSTILE_STANCE_ATTACKING)
		stance = HOSTILE_STANCE_ALERT
		stance_step = 6
		target_mob = M
