...
//	"Schizophrenia" = list(-4,list(),"Schizophrenia: You hear things and see horrible images in your head later in your life (PTSD and voices in your head)"),
	"Dwarfism" = list(1,list("Gigantism"),"You are smaller and need less food, but also have lower strength (0.8x Size, strength modifier 0.7x, decreased food requirements)"),
//	"Hyperpigmentation" = list(5,list(),"Your skin is covered in Darkened patches or spots on your skin. (You gain heat resistance a bit)"),
	"Gigantism" = list(1,list("Dwarfism"),"You are larger, need more food, and you move slower, but have higher strength (1.3x Size, decreased speed, increased food requirements, strength modifier 1.5x)"),
