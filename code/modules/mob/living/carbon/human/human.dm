	...
	if (.)
		...
		if (client.status_tabs && statpanel("Character"))
			...
			if (original_job_title == "Civilization A Citizen")
				stat("Industrial Research:", map.civa_research[1])
				stat("Military Research:", map.civa_research[2])
				stat("Health Research:",  map.civa_research[3])
			else if (original_job_title == "Civilization B Citizen")
				stat("Industrial Research:", map.civb_research[1])
				stat("Military Research:", map.civb_research[2])
				stat("Health Research:",  map.civb_research[3])
			else if (original_job_title == "Civilization C Citizen")
				stat("Industrial Research:", map.civc_research[1])
				stat("Military Research:", map.civc_research[2])
				stat("Health Research:",  map.civc_research[3])
			else if (original_job_title == "Civilization D Citizen")
				stat("Industrial Research:", map.civd_research[1])
				stat("Military Research:", map.civd_research[2])
				stat("Health Research:",  map.civd_research[3])
			else if (original_job_title == "Civilization E Citizen")
				stat("Industrial Research:", map.cive_research[1])
				stat("Military Research:", map.cive_research[2])
				stat("Health Research:",  map.cive_research[3])
			else if (original_job_title == "Civilization F Citizen")
				stat("Industrial Research:", map.civf_research[1])
				stat("Military Research:", map.civf_research[2])
				stat("Health Research:",  map.civf_research[3])
			else if (original_job_title == "Nomad")
				if (civilization != null && civilization != "none")
					stat("Industrial Research:", map.custom_civs[civilization][1])
					stat("Military Research:", map.custom_civs[civilization][2])
					stat("Health Research:",  map.custom_civs[civilization][3])
			stat("")
