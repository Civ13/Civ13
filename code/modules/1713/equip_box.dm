...
/obj/item/gunbox/specialist/attack_self(mob/living/human/user as mob)
	...
	switch (user.faction_text)
		if (DUTCH)
			options["Sniper"] = list(/obj/item/weapon/gun/projectile/semiautomatic/barrett/sniper,/obj/item/ammo_magazine/barrett,/obj/item/ammo_magazine/barrett,/obj/item/ammo_magazine/barrett,/obj/item/clothing/suit/storage/ghillie,/obj/item/clothing/head/ghillie)
		...
		if (RUSSIAN)
			options["Sniper"] = list(/obj/item/weapon/gun/projectile/semiautomatic/vintorez,/obj/item/ammo_magazine/vintorez,/obj/item/ammo_magazine/vintorez,/obj/item/clothing/suit/storage/ghillie,/obj/item/clothing/head/ghillie)
