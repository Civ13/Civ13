	...
	if (ismob(AM))
		...
		if (ishuman(M))
			...
			if (prob(33))
				...
				if (affecting && affecting.take_damage(5, 0, TRUE, TRUE))
					H.UpdateDamageIcon()
				H.updatehealth()
				if (affecting)
				...
				playsound(loc, pick('sound/effects/barbwire1.ogg','sound/effects/barbwire2.ogg','sound/effects/barbwire3.ogg'), 50, TRUE)
				var/obj/item/organ/external/affecting = H.get_organ(pick("l_foot", "r_foot", "l_leg", "r_leg"))
				if (affecting && affecting.take_damage(10, 0, TRUE, TRUE))
					H.UpdateDamageIcon()
				H.updatehealth()
				if (affecting)
				...
				playsound(loc, pick('sound/effects/barbwire1.ogg','sound/effects/barbwire2.ogg','sound/effects/barbwire3.ogg'), 50, TRUE)
				var/obj/item/organ/external/affecting = H.get_organ(pick("l_foot", "r_foot", "l_leg", "r_leg"))
				if (affecting && affecting.take_damage(15, 0, TRUE, TRUE))
					H.UpdateDamageIcon()
				H.updatehealth()
				if (affecting)
		...
		if (ishuman(M))
			...
			if(!H.immune_to_barbwire)
				if(prob(50))
					...
					playsound(loc, pick('sound/effects/barbwire1.ogg','sound/effects/barbwire2.ogg','sound/effects/barbwire3.ogg'), 50, TRUE)
					var/obj/item/organ/external/affecting = H.get_organ(pick("l_foot", "r_foot", "l_leg", "r_leg"))
					if (affecting.take_damage(4, 0, TRUE, TRUE))
						H.UpdateDamageIcon()
					H.updatehealth()
					return FALSE
				else
		...
		if (anchored)
			...
			if (prob(40))
				...
				if (ishuman(user))
					...
					playsound(loc, pick('sound/effects/barbwire1.ogg','sound/effects/barbwire2.ogg','sound/effects/barbwire3.ogg'), 50, TRUE)
					if (affecting.take_damage(18, 0, TRUE, TRUE))
						H.UpdateDamageIcon()
					H.updatehealth()
