...
obj/item/weapon/gun/projectile/bow/crossbow/enchanted
	name = "Enchanted Crossbow"
	desc = "A powerful crossbow that glows with arcane energy. It seems to be able to hold multiple bolts."
	icon_state = "ecrossbow_0"
	item_state = "ecrossbow_0"
	w_class = 4
	throw_range = 4
	throw_speed = 5
	force = 8
	...
	caliber = "bolt"
	recoil = 1 //little shaking
	fire_sound = 'sound/weapons/magic/LS_Hit_1.ogg'
	handle_casings = REMOVE_CASINGS
	load_method = SINGLE_CASING
	ammo_type = /obj/item/ammo_casing/bolt
	load_shell_sound = 'sound/weapons/pull_bow.ogg'
