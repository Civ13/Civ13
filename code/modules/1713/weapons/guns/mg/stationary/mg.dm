/obj/item/weapon/gun/projectile/automatic/stationary/maxim
	...
	firemodes = list(
		list(name = "automatic", burst=6, burst_delay=2, fire_delay=2, dispersion=list(0.7, 0.8, 0.9, 1.0, 1.1), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/pkm
	...
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1.3, fire_delay=1.3, dispersion=list(0.7, 0.8, 0.9, 1.0, 1.1), accuracy=list(2))
		)
	ammo_type = /obj/item/ammo_casing/a762x54/weak
...
/obj/item/weapon/gun/projectile/automatic/stationary/dshk
	...
	firemodes = list(
		list(name = "automatic", burst=3, burst_delay=1.2, fire_delay=1.2, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/nsvt
	...
	good_mags = list(/obj/item/ammo_magazine/ammo127)
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1.1, fire_delay=1.1, dispersion=list(0.4, 0.5, 0.6, 1.0, 1.3), accuracy=list(2))
		)
	ammo_type = /obj/item/ammo_casing/a127
...
/obj/item/weapon/gun/projectile/automatic/stationary/foldable/pkm
	...
	good_mags = list(/obj/item/ammo_magazine/pkm, /obj/item/ammo_magazine/pkm/c100, /obj/item/ammo_magazine/maxim)
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1.3, fire_delay=1.3, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
	ammo_type = /obj/item/ammo_casing/a762x54/weak
...
/obj/item/weapon/gun/projectile/automatic/stationary/vickers
	...
	firemodes = list(
		list(name = "automatic", burst=6, burst_delay=2, fire_delay=2, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/type98
	...
	firemodes = list(
		list(name = "automatic", burst=3, burst_delay=1.8, fire_delay=1.8, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/breda30
	...
	firemodes = list(
		list(name = "automatic", burst=3, burst_delay=2.5, fire_delay=1.0, dispersion = list(0.6, 0.6, 0.7, 0.8, 0.9), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/browning
	...
	firemodes = list(
		list(name = "automatic", burst=5, burst_delay=1.8, fire_delay=1.1, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/mg34
	...
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1, fire_delay=1, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
	ammo_type = /obj/item/ammo_casing/a792x57/weak
...
/obj/item/weapon/gun/projectile/automatic/stationary/blugoslavia
	...
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1.3, fire_delay=2.5, dispersion=list(0.7, 0.8, 0.9, 1.1, 1.2), accuracy=list(2))
		)
...
/obj/item/weapon/gun/projectile/automatic/stationary/redmenia
	...
	firemodes = list(
		list(name = "automatic", burst=4, burst_delay=1.3, fire_delay=2.3, dispersion=list(0.7, 0.9, 1.0, 1.1, 1.3), accuracy=list(2))
		)
	ammo_type = /obj/item/ammo_casing/a762x54
...
/obj/item/weapon/gun/projectile/automatic/stationary/autocannon/shipunov2a72 // BTR-80
	...
	firemodes = list(
		list(name = "automatic", burst=3, burst_delay=3.5, fire_delay=2.5, dispersion=list(0.1, 0.2, 0.2, 0.2), accuracy=list(2)),
		)
	ammo_type = /obj/item/ammo_casing/a30mm_ap
	full_auto = TRUE
...
/obj/item/weapon/gun/projectile/automatic/stationary/autocannon/bushmaster // CV-90
	...
	good_mags = list(/obj/item/ammo_magazine/a30mm_ap/btr80, /obj/item/ammo_magazine/a30mm_he/btr80)
	firemodes = list(
		list(name = "automatic", burst=3, burst_delay=3.5, fire_delay=2.5, dispersion=list(0.1, 0.1, 0.2, 0.2), accuracy=list(2)),
		)
	ammo_type = /obj/item/ammo_casing/a30mm_ap
	full_auto = TRUE
