...
/obj/item/clothing/shoes/heavyboots/wrappedboots
	...
	armor = list(melee = 80, arrow = 60, gun = 50,energy = 25, bomb = 50, bio = 10, rad = FALSE)
	item_flags = NOSLIP
...
/obj/item/clothing/shoes/soldiershoes
	...
	force = WEAPON_FORCE_WEAK
	armor = list(melee = 30, arrow = 20, gun = 20,energy = 15, bomb = 30, bio = 10, rad = FALSE)
	item_flags = NOSLIP
	siemens_coefficient = 0.6
...
/obj/item/clothing/shoes/blackboots1
	...
	worn_state = "sailorboots1"
	force = WEAPON_FORCE_WEAK
	armor = list(melee = 60, arrow = 50, gun = 50,energy = 25, bomb = 50, bio = 10, rad = FALSE)
	item_flags = NOSLIP
	siemens_coefficient = 0.6
	cold_protection = FEET
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
