/////////RHODESIAN//////////////
/datum/job/american/rhodesain_lieutenant
	title = "Rhodesian Lieutenant"
...
/datum/job/american/rhodesian_lieutenant/equip(var/mob/living/human/H)
	if (!H)	return FALSE
//shoes
...
/datum/job/american/rhodesian_sergeant
	title = "Rhodesian Sergeant"
...
/datum/job/american/rhodesian_sergeant/equip(var/mob/living/human/H)
	if (!H)	return FALSE
//shoes
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
...
/datum/job/american/rhodesian_scout
	title = "Rhodesian Scout"
	rank_abbreviation = "Scout"
...
/datum/job/american/rhodesian_soldier/equip(var/mob/living/human/H)
	if (!H)	return FALSE
//shoes
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
...
/datum/job/american/rhodesian_medic
	title = "Rhodesian Medic"
...
/datum/job/american/rhodesian_medic/equip(var/mob/living/human/H)
	if (!H)	return FALSE
//shoes
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
...
//back
	...
	give_random_name(H)
	H.civilization = "Rhodesian"
	H.add_note("Role", "You are a <b>[title]</b>. Keep your fellow Rhodesians alive!")
	H.setStat("strength", STAT_NORMAL)
