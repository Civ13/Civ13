...
//back
	H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/ak47/china(H), slot_shoulder)
...
//gun
	...
	switch(randimpw)
		if (1)
			...
			var/obj/item/clothing/accessory/storage/webbing/light/china/gewehr98/webbing = new /obj/item/clothing/accessory/storage/webbing/light/china/gewehr98(null)
			uniform.attackby(webbing, H)
		if (2)
			H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/ak47/china(H), slot_shoulder)
			H.equip_to_slot_or_del(new /obj/item/weapon/attachment/bayonet(H), slot_l_store)
			var/obj/item/clothing/accessory/storage/webbing/light/china/ak47/webbing = new /obj/item/clothing/accessory/storage/webbing/light/china/ak47(null)
			uniform.attackby(webbing, H)
		if (3)
			H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/semiautomatic/sks/china(H), slot_shoulder)
			H.equip_to_slot_or_del(new /obj/item/weapon/attachment/bayonet(H), slot_l_store)
			var/obj/item/clothing/accessory/storage/webbing/light/china/sks/webbing = new /obj/item/clothing/accessory/storage/webbing/light/china/sks(null)
			uniform.attackby(webbing, H)
		if (4)
			H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/ppsh/china(H), slot_shoulder)
