...
//weapons
	...
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/projectile/c762x38mmR(H), slot_l_store)
...
//back
	...
	H.equip_to_slot_or_del(new 	/obj/item/ammo_magazine/projectile/mosin(H), slot_belt)
