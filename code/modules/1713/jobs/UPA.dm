...
//head
	...
	var/obj/item/clothing/accessory/rank/upa_sgt = new /obj/item/clothing/accessory/rank/upa_sgt(null)
	uniform.attackby(upa_sgt, H)
	var/obj/item/clothing/accessory/storage/webbing/ww1/german = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
	uniform.attackby(german, H)
	german.attackby(/obj/item/ammo_magazine/mp40, H)
	german.attackby(/obj/item/ammo_magazine/mp40, H)
	german.attackby(/obj/item/ammo_magazine/mp40, H)
	german.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	give_random_name(H)
	H.s_tone = rand(-35,-25)
...
//back
	...
	if (pickgun == 1)
		...
		if (prob(50))
			...
			var/obj/item/clothing/accessory/storage/webbing/ww1/german = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
			uniform.attackby(german, H)
			german.attackby(/obj/item/ammo_magazine/dp, H)
			german.attackby(/obj/item/ammo_magazine/dp, H)
			german.attackby(/obj/item/ammo_magazine/dp, H)
			german.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
		else
			...
			var/obj/item/clothing/accessory/storage/webbing/ww1/german = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
			uniform.attackby(german, H)
			german.attackby(/obj/item/ammo_magazine/mg34, H)
			german.attackby(/obj/item/ammo_magazine/mg34, H)
			german.attackby(/obj/item/ammo_magazine/mg34, H)
			german.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
		...
		var/obj/item/clothing/accessory/storage/webbing/ww1/german = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
		uniform.attackby(german, H)
		german.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	else if (pickgun == 4)
		...
		var/obj/item/clothing/accessory/storage/webbing/ww1/german = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
		uniform.attackby(german, H)
		german.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	give_random_name(H)
	H.s_tone = rand(-35,-25)
	H.add_note("Role", "You are a <b>[title]</b>, a soldier in the Ukrayins'ka Povstans'ka Armiya. Fight for the freeodm of <b>Ukraine</b>!")
	H.add_note("Partisan Mechanics", "- Press <b>C</b> to place a booby trap while holding a grenade.")
	H.setStat("strength", STAT_MEDIUM_HIGH)
	H.setStat("crafting", STAT_MEDIUM_LOW)
