...
//head
	...
	var/obj/item/clothing/accessory/rank/upa_sgt = new /obj/item/clothing/accessory/rank/upa_sgt(null)
	uniform.attackby(upa_sgt, H)
	var/obj/item/clothing/accessory/storage/webbing/ww1/german1 = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
	uniform.attackby(german1, H)
	german1.attackby(/obj/item/ammo_magazine/mp40, H)
	german1.attackby(/obj/item/ammo_magazine/mp40, H)
	german1.attackby(/obj/item/ammo_magazine/mp40, H)
	german1.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	give_random_name(H)
	H.s_tone = rand(-35,-25)
...
//back
	...
	if (pickgun == 1)
		...
		if (prob(50))
			...
			var/obj/item/clothing/accessory/storage/webbing/ww1/german1 = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
			uniform.attackby(german1, H)
			german1.attackby(/obj/item/ammo_magazine/dp, H)
			german1.attackby(/obj/item/ammo_magazine/dp, H)
			german1.attackby(/obj/item/ammo_magazine/dp, H)
			german1.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
		else
			...
			var/obj/item/clothing/accessory/storage/webbing/ww1/german1 = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
			uniform.attackby(german1, H)
			german1.attackby(/obj/item/ammo_magazine/mg34, H)
			german1.attackby(/obj/item/ammo_magazine/mg34, H)
			german1.attackby(/obj/item/ammo_magazine/mg34, H)
			german1.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
		...
		var/obj/item/clothing/accessory/storage/webbing/ww1/german1 = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
		uniform.attackby(german1, H)
		german1.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german1.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german1.attackby(/obj/item/ammo_magazine/c762x25_ppsh, H)
		german1.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	else if (pickgun == 4)
		...
		var/obj/item/clothing/accessory/storage/webbing/ww1/german1 = new /obj/item/clothing/accessory/storage/webbing/ww1/german(null)
		uniform.attackby(german1, H)
		german1.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german1.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german1.attackby(/obj/item/ammo_magazine/gewehr98, H)
		german1.attackby(/obj/item/weapon/grenade/ww2/stg1924, H)
	give_random_name(H)
