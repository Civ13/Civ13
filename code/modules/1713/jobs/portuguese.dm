...
//head
	...
	world << "<big><b>[H.real_name] is the Captain of the Portuguese Navy ship!</b></big>"
...
//head
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/material/sword/spadroon(H), slot_belt)
	world << "<big><b>[H.real_name] is the Quartermaster of the Portuguese Navy ship!</b></big>"
...
//head
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/attachment/scope/adjustable/binoculars(H), slot_l_store)
	H.equip_to_slot_or_del(new /obj/item/weapon/material/sword/spadroon(H), slot_belt)
	world << "<big><b>[H.real_name] is the Boatswain of the Portuguese Navy ship!</b></big>"
