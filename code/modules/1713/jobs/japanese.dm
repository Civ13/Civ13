...
//clothes
	H.equip_to_slot_or_del(new /obj/item/clothing/under/japuni, slot_w_uniform)
//jacket
...
//weapons
	...
	H.equip_to_slot_or_del(new /obj/item/ammo_magazine/projectile/c9mm_jap_revolver(H), slot_l_store)
