...
//weapon
	var/randarmw = rand(1,4)
	switch(randarmw)
		if (1)
			if (prob(55))
				H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/sten(H), slot_l_hand)
				H.equip_to_slot_or_del(new /obj/item/ammo_magazine/sten2(H), slot_r_hand)
			else
		...
		if (2)
			if (prob(35))
				H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/sten/stv(H), slot_l_hand)
				H.equip_to_slot_or_del(new /obj/item/ammo_magazine/sten2(H), slot_r_hand)
			else
				H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/submachinegun/sten(H), slot_l_hand)
				H.equip_to_slot_or_del(new /obj/item/ammo_magazine/sten2(H), slot_r_hand)
