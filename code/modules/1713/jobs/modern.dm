...
//back
	...
	switch (loadout) 
		if (1)
			...
			web.attackby(new/obj/item/ammo_magazine/scarh, H)
		if (2)
			H.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/boltaction/m24(H), slot_l_hand)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/tacpouches/m24(H), slot_belt)
