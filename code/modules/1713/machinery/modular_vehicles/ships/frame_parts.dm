	...
	if (istype (I, /obj/item/stack/material/wood))
		...
		if (choice1 == "left")
			...
			if (choice3 == "crenelated wall")
				w_left = list("boat_port2",TRUE,TRUE,choice2,choice2*0.75,TRUE,TRUE)
			else if (choice3 == "open window")
				w_left = list("boat_port1",TRUE,TRUE,choice2,choice2,TRUE,TRUE)
			else
			...
			if (S.amount <= 0)
				qdel(S)
			if (choice3 == "crenelated wall")
				w_right = list("boat_port2",TRUE,TRUE,choice2,choice2*0.75,TRUE,TRUE)
			else if (choice3 == "open window")
				w_right = list("boat_port1",TRUE,TRUE,choice2,choice2,TRUE,TRUE)
			else
			...
			if (S.amount <= 0)
				qdel(S)
			if (choice3 == "crenelated wall")
				w_front = list("boat_port2",TRUE,TRUE,choice2,choice2*0.75,TRUE,TRUE)
			else if (choice3 == "open window")
				w_front = list("boat_port1",TRUE,TRUE,choice2,choice2,TRUE,TRUE)
			else
			...
			if (S.amount <= 0)
				qdel(S)
			if (choice3 == "crenelated wall")
				w_back = list("boat_port2",TRUE,TRUE,choice2,choice2*0.75,TRUE,TRUE)
			else if (choice3 == "open window")
				w_back = list("boat_port1",TRUE,TRUE,choice2,choice2,TRUE,TRUE)
			else
