...
/obj/structure/vending/yeltsinapparel
	...
	products = list(
		...
		/obj/item/clothing/under/milrus_afghanka = 15,
		/obj/item/clothing/under/milrus_omon = 10,
		/obj/item/clothing/suit/storage/jacket/milrus_vsr93 = 5,
		/obj/item/clothing/suit/storage/jacket/milrus_afghanka = 15,
		/obj/item/clothing/head/ww2/sov_ushanka = 10,
