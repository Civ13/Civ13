...
//	recipes += new/datum/stack_recipe("sandals", /obj/item/clothing/shoes/sandal, TRUE)
	...
	recipes += new/datum/stack_recipe("book shelf", /obj/structure/bookcase, 4, _time = 70, _one_per_turf = TRUE, _on_floor = TRUE)
...
//	recipes += new/datum/stack_recipe("window frame", /obj/structure/window_frame, 3, _time = 30, _one_per_turf = TRUE, _on_floor = TRUE) no more meme windows
