...
/datum/admins/proc/log_admin_rank_modification(var/adm_ckey, var/new_rank)
	...
	if (!usr.client.holder || !(usr.client.holder.rights & R_PERMISSIONS))
		to_chat(usr, "<span class = 'red'>You do not have permission to do this!</span>")
		return
	...
	if (new_rank == "Removed")
		...
		if (!foundnew)
			...
			to_chat(usr, "<span class = 'good'>New admin successfully added.</span>")
			return
		else
			...
			to_chat(usr, "<span class = 'good'>Admin rank successfully changed.</span>")
			return
// see admin/topic.dm
