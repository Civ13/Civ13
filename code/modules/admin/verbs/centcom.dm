/client/proc/CentCom(ckey)
	...
	message_admins("[key_name_admin(src)] has checked [ckey]'s bans on CentCom.", key_name_admin(src))
	var/centcom = "<!DOCTYPE html><HTML><HEAD><TITLE>Civ13 Wiki</TITLE><META http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"></HEAD> \
