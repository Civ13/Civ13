/client/proc/CentCom(ckey)
	...
	var/centcom = "<!DOCTYPE html><HTML><HEAD><TITLE>CentCom Database</TITLE><META http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"></HEAD> \
		<BODY>[common_browser_style]<iframe src=\"https://centcom.melonmesa.com/viewer/view/[ckey]%3E\" style=\"position: absolute; height: 97%; width: 97%; border: none\"></iframe></BODY></HTML>"
