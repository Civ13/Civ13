...
/client/proc/cmd_admin_pm(var/client/C, var/msg = null)
	...
	for (var/client/X in admins)
		...
		if (X.key != key && X.key != C.key && (X.holder.rights & R_ADMIN|R_MOD|R_MENTOR))
			to_chat(X, "<span class='pm'><span class='other'>" + create_text_tag("pm_other", "PM:", X) + " <span class='name'>[key_name(src, X, FALSE)]</span> to <span class='name'>[key_name(C, X, FALSE)]</span>: <span class='message'>[msg]</span></span></span>")
...
/proc/cmd_admin_pm_fromdiscord(var/client/C, var/msg = null, var/sender_name = "admins")
	...
	for (var/client/X in admins)
		...
		if ((X.holder.rights & R_ADMIN|R_MOD|R_MENTOR))
			...
			to_chat(X, "<span class='pm'><span class='other'>" + create_text_tag("pm_other", "PM:", X) + " <span class='name'><a href='?priv_msg_discord=\ref[sender_name]'>[sender_name] (discord)</span></a> to <span class='name'>[key_name(C, X, FALSE)]</span>: <span class='message'>[msg]</span></span></span>")
...
/client/proc/cmd_admin_pm_todiscord(var/target = "admins",var/msg = null)
	...
	to_chat(src, "<span class='pm'><span class='out'>" + create_text_tag("pm_out_alt", "PM", src) + " to <span class='name'>[target]</span>: <span class='message'>[msg]</span></span></span>")
	...
	for (var/client/X in admins)
		...
		if (X.key != key && (X.holder.rights & R_ADMIN|R_MOD|R_MENTOR))
			to_chat(X, "<span class='pm'><span class='other'>" + create_text_tag("pm_other", "PM:", X) + " <span class='name'>[key_name(src, X, FALSE)]</span> to <span class='name'>[target] (discord)</span>: <span class='message'>[msg]</span></span></span>")
