...
/datum/chat/proc/load()
	...
	browse_rsc_web(client, 'code/js/purify.min.js', "purify.min.js")
	browse_rsc_web(client, 'interface/fonts/Alegreya-Regular.ttf', "Alegreya-Regular.ttf")
	browse_rsc_web(client, 'interface/fonts/Alegreya-Bold.ttf', "Alegreya-Bold.ttf")
	browse_rsc_web(client, 'interface/fonts/Alegreya-Italic.ttf', "Alegreya-Italic.ttf")
	browse_rsc_web(client, 'interface/fonts/Alegreya-BoldItalic.ttf', "Alegreya-BoldItalic.ttf")
	browse_rsc_web(client, 'interface/fonts/Alegreya-Black.ttf', "Alegreya-Black.ttf")
