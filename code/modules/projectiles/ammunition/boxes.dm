...
/obj/item/ammo_magazine/SMG_sol/rubber
	...
	matter = list(DEFAULT_WALL_MATERIAL = 1575) //metal costs are very roughly based around TRUE .45 casing = 75 metal
	caliber = "9mm"
	max_ammo = 21
	multiple_sprites = TRUE
...
/obj/item/ammo_magazine/mg/cl44/rubber
	...
	ammo_mag = "mag_cl44"
	ammo_type = /obj/item/ammo_casing/cl44/rubber
	matter = list(DEFAULT_WALL_MATERIAL = 750) //metal costs are very roughly based around TRUE .45 casing = 75 metal
	caliber = ".44"
	max_ammo = 10
	multiple_sprites = TRUE
