...
/client/verb/nanoclose(var/uiref as text)
  ...
  * @return nothing
  */
/datum/proc/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = TRUE, var/datum/nano_ui/master_ui = null, var/datum/topic_state/state = default_state)
	return
