...
/turf/floor/beach/sand/desert/plant()
	...
	if (prob(3))
		...
		new/obj/structure/wild/ore_deposits/hematite_deposit(src)
	else if(prob(0.3))
		new/obj/structure/wild/ore_deposits/malachite_deposit(src)
	else if(prob(0.3))
		new/obj/structure/wild/ore_deposits/cassiterite_deposit(src)
