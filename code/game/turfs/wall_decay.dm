...
/obj/covers/proc/repair(var/obj/item/stack/I, var/mob/user)
...
/obj/covers/proc/do_repair(var/mob/user,var/obj/item/stack/I, var/amt=0)
	if (amt == 0)
		return
	...
	if (do_after(user,40,src))
		if (I.amount >= amt)
			...
			src.health += (I.amount/buildstackamount)*src.maxhealth
			qdel(I)
