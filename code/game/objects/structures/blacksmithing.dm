...
/////////////////////////
		...
		if (choice == "Cancel")
			...
			if (map.ordinal_age == 4)
				display2 = list("Small Sword (10)", "Sabre (15)", "Cutlass (12)", "Spadroon (15)", "Rapier (18)", "Katana", "Cancel")
			...
			var/list/display3 = list("Crude Musket (15)", "Flintlock Pistol (20)", "Flintlock Musketoon (25)", "Flintlock Musket (30)", "Flintlock Blunderbuss (25)","Mosin-Nagant (35)", "Murata Type 22 (35)", "Type 26 Revolver (25)", "Nagant Revolver (25)", "Cancel")
			var/choice3 = WWinput(user, "What do you want to make?", "Blacksmith - [iron_amt] iron", "Cancel", display3)
			if (choice3 == "Crude Musket (15)")
				if (iron_amt >= 15)
					user << "You begin crafting a crude musket..."
			...
			if (choice3 == "Mosin-Nagant (35)")
				if (iron_amt >= 35)
					user << "You begin crafting a Mosin..."
					playsound(loc, 'sound/effects/clang.ogg', 100, TRUE)
					if (do_after(user,170,src) && iron_amt >= 35)
			...
			if (choice3 == "Type 26 Revolver (25)")
				if (iron_amt >= 25)
...
////////////////////////////////////////////////////////
		...
		if (choice == "Cancel")
			...
			var/list/display3 = list("Crude Musket (15)", "Flintlock Pistol (20)", "Flintlock Musketoon (25)", "Flintlock Musket (30)", "Flintlock Blunderbuss (25)","Mosin-Nagant (35)", "Arisaka Type 30 (35)", "Arisaka Type 35 (35)", "Murata Type 22 (35)", "Nambu Type A (25)", "Type 26 Revolver (25)", "Nagant Revolver (25)", "Cancel")
			var/choice3 = WWinput(user, "What do you want to make?", "Blacksmith - [iron_amt] iron", "Cancel", display3)
			if (choice3 == "Crude Musket (15)")
				if (iron_amt >= 15)
					user << "You begin crafting a crude musket..."
