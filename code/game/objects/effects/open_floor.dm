...
/turf/floor/broken_floor/sky/Entered(var/atom/movable/mover)
	if (locate_dense_type(contents, /obj/structure) || locate_type(contents, /obj/structure/window/classic)) // plane windows
		...
		var/mob/living/carbon/human/H = mover
			...
			if (!H.back || !istype(H.back, /obj/item/weapon/storage/backpack/ww2/german/paratrooper))
