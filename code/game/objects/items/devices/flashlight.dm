...
/obj/item/flashlight/flare/signal/activate_signal(mob/living/human/user as mob)
	...
	switch(user.faction_text)
		if ("DUTCH")
			...
			world << SPAN_DANGER("<font size=4>The clouds open up as a F-16 cutts through and fires off a burst of rockets!</font>")
		if ("RUSSIAN")
			new /obj/effect/plane_flyby/su25_no_message(target)
			world << SPAN_DANGER("<font size=4>The clouds open up as a Su-25 cutts through and fires off a burst of rockets!</font>")
	sleep(15)
