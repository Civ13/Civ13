...
/obj/covers/roads/modern/attackby(obj/item/I, mob/living/human/user as mob)
...
/obj/covers/roads/dirt/attackby(obj/item/I, mob/living/human/user as mob)
...
/obj/covers/roads/roman/attackby(obj/item/I, mob/living/human/user as mob)
	if(I.tool_flags & TOOL_PICKAXE)
		playsound(src, 'sound/effects/pickaxe.ogg', 85, 1)
		to_chat(user, SPAN_NOTICE("You begin breaking apart \the [src]."))
		if (do_after(user,45,src))
...
/obj/covers/roads/cobble/attackby(obj/item/I, mob/living/human/user as mob)
	if(I.tool_flags & TOOL_PICKAXE)
		playsound(src, 'sound/effects/pickaxe.ogg', 85, 1)
		to_chat(user, SPAN_NOTICE("You begin breaking apart \the [src]."))
		if (do_after(user,45,src))
...
/obj/covers/roads/sandstone/attackby(obj/item/I, mob/living/human/user)
	if(I.tool_flags & TOOL_PICKAXE)
		playsound(src, 'sound/effects/pickaxe.ogg', 85, 1)
		to_chat(user, SPAN_NOTICE("You begin breaking apart \the [src]."))
		if (do_after(user,45,src))
