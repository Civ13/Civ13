/obj/map_metadata/kandahar
	...
	description = "The Soviets, along with the DRA, have to remain in control of the Kandahar province, arrest or eliminate the Mujahideen leaders that are turning the local populace aga..."
