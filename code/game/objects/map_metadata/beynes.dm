...
obj/map_metadata/beynes/job_enabled_specialcheck(var/datum/job/J)
	..()
...
/obj/map_metadata/beynes/faction2_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 4800 || admin_ended_all_grace_periods)

/obj/map_metadata/beynes/faction1_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 4800 || admin_ended_all_grace_periods)

/obj/map_metadata/beynes/short_win_time(faction)
	if (!(alive_n_of_side(faction1)) || !(alive_n_of_side(faction2)))
		return 600
	else
		return 4800 // 8 minutes

/obj/map_metadata/beynes/long_win_time(faction)
	if (!(alive_n_of_side(faction1)) || !(alive_n_of_side(faction2)))
		return 600
	else
		return 4800 // 8 minutes

/obj/map_metadata/beynes/roundend_condition_def2name(define)
	..()
	switch (define)
		if (BRITISH)
			return "English"

/obj/map_metadata/beynes/roundend_condition_def2army(define)
	..()
	switch (define)
		if (BRITISH)
...
/obj/map_metadata/beynes/army2name(army)
	..()
	switch (army)
...
/obj/map_metadata/beynes/cross_message(faction)
	if (faction == BRITISH)
...
/obj/map_metadata/beynes/reverse_cross_message(faction)
	if (faction == ENGLISH)
...
/obj/map_metadata/beynes/update_win_condition()
