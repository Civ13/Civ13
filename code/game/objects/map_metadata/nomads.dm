...
/obj/map_metadata/nomads/proc/seasons()
	if (season == "WINTER")
		...
		for (var/turf/floor/dirt/D)
			if (prob(50) && !istype(D, /turf/floor/dirt/underground) && !istype(D, /turf/floor/dirt/dust) && !istype(D, /turf/floor/dirt/ploughed) && get_area(D).location == AREA_OUTSIDE)
		...
		spawn(15000)
			...
			for (var/turf/floor/dirt/D in get_area_turfs(/area/caribbean/nomads/forest))
				if (get_area(D).location == AREA_OUTSIDE && prob(40) && !istype(D, /turf/floor/dirt/underground) && !istype(D, /turf/floor/dirt/dust))
		...
		for (var/turf/floor/dirt/D in get_area_turfs(/area/caribbean/nomads/forest))
			if (!istype(D,/turf/floor/dirt/winter) && !istype(D,/turf/floor/dirt/underground))
				if (get_area(D).location == AREA_OUTSIDE)
					D.ChangeTurf(/turf/floor/dirt/winter)
		for (var/turf/floor/grass/G)
			G.ChangeTurf(/turf/floor/winter/grass)
		spawn(100)
