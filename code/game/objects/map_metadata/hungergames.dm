	...
	switch(artc)
		if ("one")
			...
			for(var/mob/living/human/H in player_list)
				...
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/one) || istype(A,/area/caribbean/no_mans_land/battleroyale/one/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "North-Western Area"))
		...
		if ("two")
			...
			for(var/mob/living/human/H in player_list)
				var/area/A = get_area(get_turf(H))
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/two) || istype(A,/area/caribbean/no_mans_land/battleroyale/two/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "North-Eastern Area"))
					playsound(H, sound_to_play, 100, FALSE, -1)
					spawn(30)
						playsound(H, "sound/voice/battleroyale/close[time].ogg", 100, FALSE, -1)
		if ("three")
			...
			for(var/mob/living/human/H in player_list)
				var/area/A = get_area(get_turf(H))
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/three) || istype(A,/area/caribbean/no_mans_land/battleroyale/three/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "Western Area"))
					playsound(H, sound_to_play, 100, FALSE, -1)
					spawn(30)
						playsound(H, "sound/voice/battleroyale/close[time].ogg", 100, FALSE, -1)
		if ("four")
			...
			for(var/mob/living/human/H in player_list)
				var/area/A = get_area(get_turf(H))
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/four) || istype(A,/area/caribbean/no_mans_land/battleroyale/four/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "Eastern Area"))
					playsound(H, sound_to_play, 100, FALSE, -1)
					spawn(30)
						playsound(H, "sound/voice/battleroyale/close[time].ogg", 100, FALSE, -1)
		if ("five")
			...
			for(var/mob/living/human/H in player_list)
				var/area/A = get_area(get_turf(H))
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/five) || istype(A,/area/caribbean/no_mans_land/battleroyale/five/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "South-Western Area"))
					playsound(H, sound_to_play, 100, FALSE, -1)
					spawn(30)
						playsound(H, "sound/voice/battleroyale/close[time].ogg", 100, FALSE, -1)
		if ("six")
			...
			for(var/mob/living/human/H in player_list)
				var/area/A = get_area(get_turf(H))
				if (istype(A,/area/caribbean/no_mans_land/battleroyale/six) || istype(A,/area/caribbean/no_mans_land/battleroyale/six/inside) || (istype(A,/area/caribbean/no_mans_land/invisible_wall) && A.name == "South-Eastern Area"))
					playsound(H, sound_to_play, 100, FALSE, -1)
					spawn(30)
						playsound(H, "sound/voice/battleroyale/close[time].ogg", 100, FALSE, -1)
		if ("none")
...
/obj/map_metadata/hunger_games/proc/close_area(var/artc = null)
	...
	switch(artc)
		if ("one")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/one))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/one/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "North-Western Area")
						H.crush()
		...
		if ("two")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/two))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/two/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "North-Eastern Area")
						H.crush()
		...
		if ("three")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/three))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/three/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "Western Area")
						H.crush()
		...
		if ("four")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/four))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/four/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "Eastern Area")
						H.crush()
		...
		if ("five")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/five))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/five/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "South-Western Area")
						H.crush()
		...
		if ("six")
			...
			spawn(20)
				for(var/mob/living/human/H in player_list)
					if (istype(H,/area/caribbean/no_mans_land/battleroyale/six))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/battleroyale/six/inside))
						H.crush()
					else if (istype(H,/area/caribbean/no_mans_land/invisible_wall) && H.name == "South-Eastern Area")
						H.crush()
