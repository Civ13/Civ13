		...
		if (season == "FALL")
			...
			for (var/turf/floor/dirt/DT in get_area_turfs(/area/caribbean/nomads/forest))
				if (!istype(DT, /turf/floor/dirt/underground))
					var/area/A2 = get_area(DT)
					if (A2.climate == "temperate")
						if (prob(75))
							DT.ChangeTurf(/turf/floor/dirt/winter)
					else if (A2.climate == "tundra" || A2.climate == "taiga")
						DT.ChangeTurf(/turf/floor/dirt/winter)
			for (var/turf/floor/grass/GT in get_area_turfs(/area/caribbean/nomads/forest))
				var/area/A3 = get_area(GT)
				if (A3.climate == "temperate")
					if (prob(80))
						GT.ChangeTurf(/turf/floor/winter/grass)
				else if (A3.climate == "tundra" || A3.climate == "taiga")
					GT.ChangeTurf(/turf/floor/winter/grass)
			...
			for (var/turf/floor/dirt/winter/D in get_area_turfs(/area/caribbean/nomads/forest))
				var/area/A1 = get_area(D)
				if (A1.climate == "temperate")
					if (prob(60))
						if (prob(40))
			...
			for (var/turf/floor/winter/grass/G in get_area_turfs(/area/caribbean/nomads/forest))
				var/area/A4 = get_area(G)
				if (A4.climate == "temperate")
					if (prob(60))
						G.ChangeTurf(/turf/floor/grass)
			spawn(150)
				change_weather(WEATHER_NONE)
				for (var/obj/structure/window/barrier/snowwall/SW1 in world)
					var/area/A5 = get_area(get_turf(SW1))
					if (A5.climate != "tundra" && A5.climate != "taiga")
						if (prob(60))
							qdel(SW1)
				for (var/obj/covers/snow_wall/SW2 in world)
					var/area/A6 = get_area(get_turf(SW2))
					if (A6.climate != "tundra" && A6.climate != "taiga")
						if (prob(60))
							qdel(SW2)
				for (var/obj/item/weapon/snowwall/SW3 in world)
					var/area/A7 = get_area(get_turf(SW3))
					if (A7.climate != "tundra" && A7.climate != "taiga")
						if (prob(60))
							qdel(SW3)
			spawn(3000)
				for (var/turf/floor/dirt/winter/D in get_area_turfs(/area/caribbean/nomads/forest))
				...
				for (var/turf/floor/dirt/D in get_area_turfs(/area/caribbean/nomads/semiarid))
					var/area/A1 = get_area(D)
					if (A1.climate == "semiarid" && !istype(D, /turf/floor/dirt/dust) && !istype(D, /turf/floor/dirt/underground))
						if (prob(40))
							D.ChangeTurf(/turf/floor/grass)
			...
			spawn(15000)
				...
				for (var/turf/floor/dirt/D in get_area_turfs(/area/caribbean/nomads/forest))
					var/area/A1 = get_area(D)
					if (z == world.maxz && prob(40) && !istype(D, /turf/floor/dirt/underground) && !istype(D, /turf/floor/dirt/dust) && !(A1.climate == "jungle"))
				...
				spawn(1200)
					for (var/turf/floor/dirt/D in get_area_turfs(/area/caribbean/nomads/forest))
						var/area/A1 = get_area(D)
						if (!istype(D,/turf/floor/dirt/winter) && (A1.climate == "temperate"))
