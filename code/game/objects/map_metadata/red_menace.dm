/obj/map_metadata/red_menace
	...
	lobby_icon_state = "redmenace"
	caribbean_blocking_area_types = list(/area/caribbean/no_mans_land/invisible_wall, /area/caribbean/no_mans_land/invisible_wall/one, /area/caribbean/no_mans_land/invisible_wall/inside/two)
	respawn_delay = 1200
	no_hardcore = TRUE
	victory_time = 36000
