...
/obj/map_metadata/europecolony
	ID = MAP_COLONY
	title = "Colony (Europe) (420x480x2)"
...
/obj/map_metadata/europecolony/New()
	..()
	spawn(18000)
		seasons()

obj/map_metadata/europecolony/job_enabled_specialcheck(var/datum/job/J)
	..()
	...
	if (istype(J, /datum/job/civilian/fantasy))
		. = FALSE
/obj/map_metadata/europecolony/faction2_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 15000 || admin_ended_all_grace_periods)

/obj/map_metadata/europecolony/faction1_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 15000 || admin_ended_all_grace_periods)

/obj/map_metadata/europecolony/cross_message(faction)
	return ""
