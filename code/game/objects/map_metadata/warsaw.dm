/obj/map_metadata/warsaw
	...
	mission_start_message = "<font size=4>All factions have <b>5 minutes</b> to prepare before the ceasefire ends!<br>The Polish Home Army will win if they hold out for <b>45 minutes</b>. The Wehrmacht will win if they manage to reach the <b>Radio Station</b> in the Polish Home Army HQ.</font>"
	faction1 = GERMAN
	faction2 = POLISH
...
/obj/map_metadata/warsaw/update_win_condition()
	...
	if (world.time >= 27000)
		...
		var/message = "The <b>Polish Home army</b> Has successfully defended the HQ!"
	...
	if ((current_winner && current_loser && world.time > next_win) && no_loop_r == FALSE)
		ticker.finished = TRUE
		var/message = "The <b>Germans</b> have captured the building! The battle for warsaw is over!"
		world << "<font size = 4><span class = 'notice'>[message]</span></font>"
		show_global_battle_report(null)
		win_condition_spam_check = TRUE
		no_loop_r = TRUE
	...
	// German major
		...
		if (!win_condition.check(typesof(roundend_condition_sides[roundend_condition_sides[1]]), roundend_condition_sides[2], roundend_condition_sides[1], 1.33))
			if (last_win_condition != win_condition.hash)
				current_win_condition = "The <b>Germans</b> have reached the radio station! They will win in {time} minutes."
