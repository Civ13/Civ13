/obj/map_metadata/marco_polo_bridge
	...
	description = "The Imperial Japanese Army and the Kuomintang are battling for the control of Marco Polo Bridge!"
...
/obj/map_metadata/marco_polo_bridge/update_win_condition()
	...
	// Soviet minor
		...
		if (current_win_condition != no_winner && current_winner && current_loser)
			to_chat(world, "<font size = 3>The [current_winner] has lost control of the Island!</font>")
			current_winner = null
			current_loser = null
		next_win = -1
