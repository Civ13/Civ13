...
///////////////////////////////////////////////////////////////////////
/obj/map_metadata/campaign/rotstadt
	victory_time = 48000
	grace_wall_timer = 9000
	mission_start_message = "<font size=4><b>15 minutes</b> until the battle begins.</font>"
	roundend_condition_sides = list(
...
obj/map_metadata/campaign/rotstadt/job_enabled_specialcheck(var/datum/job/J)
	if (istype(J, /datum/job/civilian))
		if (J.is_rotstadt)
			. = TRUE
		else
		...
		. = FALSE
/obj/map_metadata/campaign/rotstadt/update_win_condition()
