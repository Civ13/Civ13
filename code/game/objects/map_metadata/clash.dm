...
/obj/map_metadata/clash
	...
	mission_start_message = "<font size=4>The <b>Bear</b> clan is sieging the <b>Raven</b> clan's settlement hidden away in the snowy hills! The Bear clan will win if it manages to <b>hold the King's Cabin for 5 minutes</b>.<br> The siege will start after <b>6 minutes</b>.</font>"
	faction1 = GREEK
	faction2 = ROMAN
	valid_weather_types = list(WEATHER_NONE, WEATHER_WET)
	ambience = list('sound/ambience/jungle1.ogg')
	songs = list(
		"Filip Lackovic - Warbringer:1" = "sound/music/warbringer.ogg",)
	gamemode = "Siege"
...
/obj/map_metadata/clash/update_win_condition()
	...
	if (world.time >= 3000)
		...
		var/message = "The Raven clan has managed to defend the King's cabin!"
	...
	// German major
		...
		if (!win_condition.check(typesof(roundend_condition_sides[roundend_condition_sides[1]]), roundend_condition_sides[2], roundend_condition_sides[1], 1.33))
			if (last_win_condition != win_condition.hash)
				current_win_condition = "The Bear clan has control over the king's cabin! They will win in {time} minutes."
