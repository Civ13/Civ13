...
/obj/map_metadata/ruhruprising/job_enabled_specialcheck(var/datum/job/J)
	..()
	if (J.is_interwar)
		. = TRUE
	else
...
/obj/map_metadata/ruhruprising/short_win_time(faction)
	if (!(alive_n_of_side(faction1)) || !(alive_n_of_side(faction2)))
		return 600
	else
		return 3000 // 5 minutes

/obj/map_metadata/ruhruprising/long_win_time(faction)
	if (!(alive_n_of_side(faction1)) || !(alive_n_of_side(faction2)))
		return 600
	else
		return 3000 // 5 minutes

/obj/map_metadata/ruhruprising/roundend_condition_def2name(define)
	..()
	switch (define)
		if (CIVILIAN)
...
/obj/map_metadata/ruhruprising/roundend_condition_def2army(define)
	..()
	switch (define)
		if (CIVILIAN)
			return "Ruhr Red Army"
...
/obj/map_metadata/ruhruprising/army2name(army)
	..()
	switch (army)
		if ("CIVILIAN")
			return "Ruhr Red Army"
...
/obj/map_metadata/ruhruprising/cross_message(faction)
	if (faction == GERMAN)
...
/obj/map_metadata/ruhruprising/reverse_cross_message(faction)
	if (faction == GERMAN)
...
/obj/map_metadata/ruhruprising/update_win_condition()
...
/obj/map_metadata/ruhruprising/check_caribbean_block(var/mob/living/human/H, var/turf/T)
