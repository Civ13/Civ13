/obj/map_metadata/factory
	...
	mission_start_message = "<font size=4>The <b>Ukrainian Ground Forces</b> must defend their front line from the Russian Advance. The <b>Russian Federal Forces</b> must defend their base.<br>All factions have <b>5 minutes</b> to prepare before the combat starts.</font>"
	faction1 = CIVILIAN
	faction2 = RUSSIAN
	valid_weather_types = list(WEATHER_WET, WEATHER_NONE, WEATHER_EXTREME)
	songs = list(
		"Vopli Vidopliassova - Vesna:1" = 'sound/music/vesna.ogg',)
	artillery_count = 0
