...
///////////////////////////////////////////////////////////////////
		...
		switch (mob_area.climate)
			...
			if ("temperate")
				...
				possible_h_list = list("Dirty Blond","Light Brown","Black")
				possible_e_list = list("Brown","Green")
				possible_s_list = list(-15,-32)
			if ("snow")
				...
				possible_h_list = list("Brown","Black","Dirty Blond")
				possible_e_list = list("Brown","Blue")
				possible_s_list = list(-12,-29)
			if ("semiarid","desert")
