...
/mob/new_player/New()
	...
	spawn(20)
		if (map && map.ID == MAP_THE_ART_OF_THE_DEAL)
			...
			<BODY><iframe src=\"https://civ13.github.io/civ13-wiki/gamemodes/The_Art_of_the_Deal\"  style=\"position: absolute; height: 97%; width: 97%; border: none\"></iframe></BODY></HTML>"
			src << browse(htmlfile,"window=wiki;size=820x650")
		if (map && map.ID == MAP_GULAG13)
			var/htmlfile = "<!DOCTYPE html><HTML><HEAD><TITLE>Wiki Guide</TITLE><META http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"></HEAD> \
			<BODY><iframe src=\"https://civ13.github.io/civ13-wiki/maps/Gulag_13\"  style=\"position: absolute; height: 97%; width: 97%; border: none\"></iframe></BODY></HTML>"
			src << browse(htmlfile,"window=wiki;size=820x650")
		...
		if (map && map.ID == MAP_WIZARD_BOY)
			var/htmlfile = "<!DOCTYPE html><HTML><HEAD><TITLE>Wiki Guide</TITLE><META http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"></HEAD> \
			<BODY><iframe src=\"https://civ13.github.io/civ13-wiki/gamemodes/wizard_boy\"  style=\"position: absolute; height: 97%; width: 97%; border: none\"></iframe></BODY></HTML>"
			src << browse(htmlfile,"window=wiki;size=820x650")
			...
			if (map.ID == MAP_ONG_THAHN)
				if (actual_job && findtext(href_list["SelectedJob"],"USA"))
					if (actual_job.uses_squads)
						...
						else if (processes.ticker.playtime_elapsed >= 3600 || map.admin_ended_all_grace_periods)
							actual_job.spawn_location = "JoinLateRN"
