...
//		"noise" = list("type" = /obj/screen/noise, "loc" = "WEST,SOUTH to EAST,NORTH", "icon" = 'icons/effects/static.dmi', "icon_state" = "1 light"),
	...
	HUDneed = list(
		...
		"damage zone" = list("type" = /obj/screen/zone_sel,   "loc" = "16,9"),
		"fixeye"     = list("type" = /obj/screen/fixeye,     "loc" = "16,8"),
		"tactic"      = list("type" = /obj/screen/tactic,     "loc" = "16,7"),
		"mode"        = list("type" = /obj/screen/mode,       "loc" = "16,6"),
		"secondary attack"   = list("type" = /obj/screen/kick_jump_bite,       "loc" = "16,5"),
