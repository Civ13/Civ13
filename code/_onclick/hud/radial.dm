...
///////////////////////////////////////////////////////////////////////////////
/* Radial Menu Ported from (OLD) TGStation13 and edited for Eternal Kingdoms */
///////////////////////////////////////////////////////////////////////////////

#define NEXT_PAGE_ID "__next__"
#define DEFAULT_CHECK_DELAY 20

var/radial_menus = list()
...
/datum/radial_menu
	...
	var/zone = 360
	var/min_angle = 60 //Defaults are setup for this value, if you want to make the menu more dense these will need changes.
	var/max_elements
	var/pages = 1
	var/current_page = 1
...
*/
/proc/show_radial_menu(mob/user, atom/anchor, list/choices, uniqueid, radius, require_near = FALSE)
